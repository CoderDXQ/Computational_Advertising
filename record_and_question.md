...
GSP：广义第二高价（Generalized Second Price），是竞价广告的一种竞价理论，可以不按照微观上的最优方案实施就可以达到整个市场最大的收益。意思是给出价最高的广告主（广告位置获得者）按照出价第二高的价格收费。
...
1. 广告网咯是为了出售剩余流量而产生的，也采用竞价的方式出售，在广告网络中广告位的概念被淡化，主要售卖的标的物是人群，而合约广告是很难淡化广告位标的概念的。
2. 广告网络分为水平广告网络和垂直广告网络，穿山甲等广告联盟可以认为是水平广告网络，淘宝客可以认为是垂直广告网络。前者广泛承接各种广告库存并面向所有品类的广告主服务，后者专注于服务某一类型的广告主，尤其是电商、游戏。

## 程序化交易广告

1. 在线广告的市场发展方向是向需求方彻底开放，实时竞价的交易方式因此产生，这也使得广告市场向着透明的比价平台的方向发展，这就是广告交易平台，即ADX。在这个过程中，整个在线广告市场越来越向着数据驱动、计算导向的方式前进。
2. 用定制化标签指导广告投放是实时竞价的关键产品目标。广告平台或者流量方在加工人群标签时需要利用到广告主的数据，这样的标签称为定制化用户标签。
3. 优选：允许单个需求方按照自己的意愿来挑选流量，同时避免复杂的竞价过程。优选的决策过程可能存在比较多的服务器往返，这导致缺点是可能增大用户看到的广告延迟，从而影响广告效果。
4. 私有市场：优质媒体方邀请有能力的广告主参与竞价，可以保证媒体的质量不被广告损害，同时能保证媒体方的收入。优质媒体一般不会加入ADX。
5. 重定向：网站重定向、个性化重定向、搜索重定向。网站重定向需要广告主网站的数据，搜索重定向使用的是搜索引擎的第二方数据。重定向也是一种定制化标签。重定向虽然精准，但是投放量也不会很大。
6. 新客推荐：也是一种定制化标签，根据广告主的数据找出流量方手中可能对广告主业务感兴趣的新客，即look-alike。

## 原生广告

1.  原生广告可以提高移动环境下广告的变现能力。在移动互联网时代，移动展示广告可以利用位置信息等更好的服务本地广告主。
2. 为什么要做朋友圈这种功能，就是要用信息流变现。
...
![image-20201022011743076](/Users/duanxiangqing/Library/Application Support/typora-user-images/image-20201022011743076.png)

### 程序化交易方式

![image-20201022114538867](/Users/duanxiangqing/Library/Application Support/typora-user-images/image-20201022114538867.png)

### 在线广告主要交易方式

![image-20201022114642556](/Users/duanxiangqing/Library/Application Support/typora-user-images/image-20201022114642556.png)
